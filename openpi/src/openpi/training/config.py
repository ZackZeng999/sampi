...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_sam_dim_expert_lora",
        # SAM-dim adaptation: keep the visual-language backbone frozen and train only
        # the LoRA weights injected into the action expert.
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
        ...
        num_train_steps=30_000,
        # Freeze every non-LoRA parameter. Since only the action expert uses a LoRA
        # variant in this config, the trainable set is exactly action-expert LoRA.
